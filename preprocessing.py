...
def getMaskedArray(i, mod):
    ...
    arr = sitk.GetArrayFromImage(sitk.ReadImage(dct[i][mod]))[x_0 - x_r: x_0 + x_r, y_0 - y_r: y_0 + y_r,
          z_0 - z_r: z_0 + z_r]
...
def getMaskedArrayVal(i, mod):
    '''returns cropped array, where values 0 are masked'''
    arr = sitk.GetArrayFromImage(sitk.ReadImage(dctVal[i][mod]))[x_0 - x_r: x_0 + x_r, y_0 - y_r: y_0 + y_r,
          z_0 - z_r: z_0 + z_r]
    return ma.masked_values(arr, 0)
...
def getMaskedArrayTest(i, mod):
    '''returns cropped array, where values 0 are masked'''
    arr = sitk.GetArrayFromImage(sitk.ReadImage(dctTest[i][mod]))[x_0 - x_r: x_0 + x_r, y_0 - y_r: y_0 + y_r,
          z_0 - z_r: z_0 + z_r]
    return ma.masked_values(arr, 0)
...
def outputToChannels(id):
    arr = np.array(sitk.GetArrayFromImage(sitk.ReadImage(dct[id][4])))[x_0 - x_r: x_0 + x_r, y_0 - y_r: y_0 + y_r,
          z_0 - z_r: z_0 + z_r]
